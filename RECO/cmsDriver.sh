...
# RAW - AOD, pp reco 374666 from root file
cmsDriver.py reco  --conditions 132X_dataRun3_Express_v4 -s RAW2DIGI,L1Reco,RECO --datatier RECO --eventcontent AOD --data  --process RECO --scenario pp --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run3 --no_exec --era Run3_2023 --repacked --filein file:/eos/cms/tier0/store/hidata/HIRun2023A/HIForward0/RAW/v1/000/374/666/00000/00b2cbcd-e36d-4ca6-9302-5ab944772af8.root --nThreads 4 -n 10 

...
## User Input ##############################################################################
pset_name       = 'skim_Trig.py'

request_name    = 'skim_Trig_HIForward_ZB'
channel         = 'HIForward_ZB'
request_name    += '_%s' % datetime.now().strftime('%y%m%d_%H%M%S')

input_filelist	= '/afs/cern.ch/user/j/jiazhao/fileList/HIForward/HIForward0_HIRun2023A_16Jan2024.txt'
# input_dataset	= '/HIForward0/HIRun2023A-16Jan2024-v1/AOD'

output_pd       = 'PbPb2023'
output_dir      = '/store/group/phys_heavyions/jiazhao/Data_Run3/HIForward/%s' %  request_name
